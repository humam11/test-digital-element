(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&t(r)}).observe(document,{childList:!0,subtree:!0});function s(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(i){if(i.ep)return;i.ep=!0;const o=s(i);fetch(i.href,o)}})();function n(a=!0){const e=document.createElement("footer");return a?e.innerHTML=`
    ...
    `,e}class d{constructor(e,s=!0){this.bodyElement=e,this.footerElement=null,this.isDetailed=s}render(){this.footerElement=n(this.isDetailed);const e=this.bodyElement.querySelector("main");return e?e.insertAdjacentElement("afterend",this.footerElement):this.bodyElement.appendChild(this.footerElement),this.footerElement}}function c(a="index"){const e=document.createElement("header");return e.innerHTML=`
    <a href="#" class="logo">
  ...
  `,e}class l{constructor(e=null,s="page"){this.container=e,this.mode=s,this.formElement=null,this.modalElement=null,this.isOpen=!1}static create(e=null){const s=window.location.pathname,t=s.includes("contact")||s.includes("contact-us")?"page":"modal";return new l(e,t)}createFormHTML(){return`
